...
const char* FINANCE_DATA_DESCRIPTION[] = {"SQL", "CSV", "SHM"};
...
const bool DEFAULT_CONTINUE_WHEN_NOT_EXIST = true;
const char* DEFAULT_CSV_ROOT_FINANCE_FOLDERPATH = "/var/tmp/finance";
const char* DEFAULT_SHM_ROOT_FINANCE_FOLDERPATH = "/dev/shm/finance";
const char* SHM_ROOT_FILEPATH = "/dev/shm";
const int SHM_ROOT_FILEPATH_LEN = strlen(SHM_ROOT_FILEPATH);
...
const int* FINANCE_FS_DATA_FIELD_TYPE_LIST[] = {
	FS_STOCK_EXCHANGE_AND_VALUE_FIELD_TYPE_DEFINITION,
	FS_STOCK_TOP3_LEGAL_PERSONS_NET_BUY_OR_SELL_FIELD_TYPE_DEFINITION,
	FS_STOCK_MARGIN_TRADING_AND_SHORT_SELLING_FIELD_TYPE_DEFINITION,
	FS_FUTURE_AND_OPTION_TOP3_LEGAL_PERSONS_OPEN_INTEREST_FIELD_TYPE_DEFINITION,
	FS_FUTURE_OR_OPTION_TOP3_LEGAL_PERSONS_OPEN_INTEREST_FIELD_TYPE_DEFINITION,
	FS_OPTION_TOP3_LEGAL_PERSONS_BUY_AND_SELL_OPTION_OPEN_INTEREST_FIELD_TYPE_DEFINITION,
	FS_OPTION_PUT_CALL_RATIO_FIELD_TYPE_DEFINITION,
	FS_FUTURE_TOP10_DEALERS_AND_LEGAL_PERSONS_FIELD_TYPE_DEFINITION,
	FS_COMPANY_DEPOSITORY_SHAREHOLDER_DISTRIBUTION_FIELD_TYPE_DEFINITION,
	FS_BALANCE_SHEET_FIELD_TYPE_DEFINITION,
	FS_INCOME_STATEMENT_FIELD_TYPE_DEFINITION,
	FS_CASH_FLOW_STATEMENT_FIELD_TYPE_DEFINITION,
	FS_STATEMENT_OF_CHANGES_IN_EQUITY_FIELD_TYPE_DEFINITION
};
...
const int FINANCE_FS_DATA_FIELD_AMOUNT_LIST[] =
{
	FS_STOCK_EXCHANGE_AND_VALUE_FIELD_TYPE_DEFINITION_SIZE,
	FS_STOCK_TOP3_LEGAL_PERSONS_NET_BUY_OR_SELL_FIELD_TYPE_DEFINITION_SIZE,
	FS_STOCK_MARGIN_TRADING_AND_SHORT_SELLING_FIELD_TYPE_DEFINITION_SIZE,
	FS_FUTURE_AND_OPTION_TOP3_LEGAL_PERSONS_OPEN_INTEREST_FIELD_TYPE_DEFINITION_SIZE,
	FS_FUTURE_OR_OPTION_TOP3_LEGAL_PERSONS_OPEN_INTEREST_FIELD_TYPE_DEFINITION_SIZE,
	FS_OPTION_TOP3_LEGAL_PERSONS_BUY_AND_SELL_OPTION_OPEN_INTEREST_FIELD_TYPE_DEFINITION_SIZE,
	FS_OPTION_PUT_CALL_RATIO_FIELD_TYPE_DEFINITION_SIZE,
	FS_FUTURE_TOP10_DEALERS_AND_LEGAL_PERSONS_FIELD_TYPE_DEFINITION_SIZE,
	FS_COMPANY_DEPOSITORY_SHAREHOLDER_DISTRIBUTION_FIELD_TYPE_DEFINITION_SIZE,
	FS_BALANCE_SHEET_FIELD_TYPE_DEFINITION_SIZE,
	FS_INCOME_STATEMENT_FIELD_TYPE_DEFINITION_SIZE,
	FS_CASH_FLOW_STATEMENT_FIELD_TYPE_DEFINITION_SIZE,
	FS_STATEMENT_OF_CHANGES_IN_EQUITY_FIELD_TYPE_DEFINITION_SIZE
};
