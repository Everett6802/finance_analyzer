...
extern const bool DEFAULT_CONTINUE_WHEN_NOT_EXIST;
extern const char* DEFAULT_CSV_ROOT_FINANCE_FOLDERPATH;
extern const char* DEFAULT_SHM_ROOT_FINANCE_FOLDERPATH;
extern const char* SHM_ROOT_FILEPATH;
extern const int SHM_ROOT_FILEPATH_LEN;
...
#define FINANCE_FS_FILE_NAME_LIST FINANCE_METHOD_DATA_NAME_LIST
#define FINANCE_FS_FILE_NAME_LIST_LEN FINANCE_METHOD_DATA_NAME_LIST_LEN
...
#define FINANCE_SHM_FILE_NAME_LIST FINANCE_METHOD_DATA_NAME_LIST
#define FINANCE_SHM_FILE_NAME_LIST_LEN FINANCE_METHOD_DATA_NAME_LIST_LEN
extern const char* FINANCE_METHOD_DESCRIPTION_LIST[];
extern const int* FINANCE_SQL_DATA_FIELD_TYPE_LIST[];
extern const int* FINANCE_FS_DATA_FIELD_TYPE_LIST[];
#define FINANCE_CSV_DATA_FIELD_TYPE_LIST FINANCE_FS_DATA_FIELD_TYPE_LIST
#define FINANCE_SHM_DATA_FIELD_TYPE_LIST FINANCE_FS_DATA_FIELD_TYPE_LIST
extern const int FINANCE_SQL_DATA_FIELD_AMOUNT_LIST[];
extern const int FINANCE_FS_DATA_FIELD_AMOUNT_LIST[];
#define FINANCE_CSV_DATA_FIELD_AMOUNT_LIST FINANCE_FS_DATA_FIELD_AMOUNT_LIST
#define FINANCE_SHM_DATA_FIELD_AMOUNT_LIST FINANCE_FS_DATA_FIELD_AMOUNT_LIST
