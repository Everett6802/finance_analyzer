...
const int* FINANCE_DATABASE_FIELD_TYPE_LIST[] =
{
	...
	COMPANY_DEPOSITORY_SHAREHOLDER_DISTRIBUTION_FIELD_TYPE_DEFINITION,
	BALANCE_SHEET_FIELD_TYPE_DEFINITION,
	INCOME_STATEMENT_FIELD_TYPE_DEFINITION,
...
const int FINANCE_DATABASE_FIELD_AMOUNT_LIST[] =
{
	...
	COMPANY_DEPOSITORY_SHAREHOLDER_DISTRIBUTION_FIELD_TYPE_DEFINITION_SIZE,
	BALANCE_SHEET_FIELD_TYPE_DEFINITION_SIZE,
	INCOME_STATEMENT_FIELD_TYPE_DEFINITION_SIZE,
	CASH_FLOW_STATEMENT_FIELD_TYPE_DEFINITION_SIZE,
	STATEMENT_OF_CHANGES_IN_EQUITY_FIELD_TYPE_DEFINITION_SIZE
};
