...
class CsvSourceParam : public FsSourceParam
{
public:
	CsvSourceParam();
	CsvSourceParam(bool new_continue_when_non_exist, const char* new_root_folderpath);
	virtual ~CsvSourceParam();

	virtual FinanceDataType get_type()const;
	virtual unsigned short to_object(ISource** source_obj);
};
typedef CsvSourceParam* PCSV_SOURCE_PARAM;

///////////////////////////////////////////////////////////////////////////

class CsvSource : public FsSource
{
public:
