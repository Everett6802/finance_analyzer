...
float average(const FinanceDataArrayTemplate<T>& finance_data_array, int start_index, int end_index)
{
	...
	if (end_index == -1)
		end_index = finance_data_array.get_size();
...
float covariance(const FinanceDataArrayTemplate<T1>& finance_data_array1, const FinanceDataArrayTemplate<T2>& finance_data_array2, int start_index1, int start_index2, int end_index1, int end_index2)
{
	...
	if (end_index1 == -1)
		end_index1 = finance_data_array1.get_size();
	if (end_index2 == -1)
		end_index2 = finance_data_array2.get_size();
...
float correlation(const PFINANCE_DATA_ARRAY_BASE finance_data_array1, PFINANCE_DATA_ARRAY_BASE finance_data_array2, int start_index1, int start_index2, int end_index1, int end_index2)
{
...
//	FinanceFieldType field_type2 = finance_data_array2->get_type();
	...
	case FinanceField_INT_INT:
		correlation_value = correlation(*(PFINANCE_INT_DATA_ARRAY)finance_data_array1, *(PFINANCE_INT_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_INT_LONG:
		correlation_value = correlation(*(PFINANCE_INT_DATA_ARRAY)finance_data_array1, *(PFINANCE_LONG_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_INT_FLOAT:
		correlation_value = correlation(*(PFINANCE_INT_DATA_ARRAY)finance_data_array1, *(PFINANCE_FLOAT_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_LONG_INT:
		correlation_value = correlation(*(PFINANCE_LONG_DATA_ARRAY)finance_data_array1, *(PFINANCE_INT_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_LONG_LONG:
		correlation_value = correlation(*(PFINANCE_LONG_DATA_ARRAY)finance_data_array1, *(PFINANCE_LONG_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_LONG_FLOAT:
		correlation_value = correlation(*(PFINANCE_LONG_DATA_ARRAY)finance_data_array1, *(PFINANCE_FLOAT_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_FLOAT_INT:
		correlation_value = correlation(*(PFINANCE_FLOAT_DATA_ARRAY)finance_data_array1, *(PFINANCE_INT_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_FLOAT_LONG:
		correlation_value = correlation(*(PFINANCE_FLOAT_DATA_ARRAY)finance_data_array1, *(PFINANCE_LONG_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	case FinanceField_FLOAT_FLOAT:
		correlation_value = correlation(*(PFINANCE_FLOAT_DATA_ARRAY)finance_data_array1, *(PFINANCE_FLOAT_DATA_ARRAY)finance_data_array2, start_index1, start_index2, end_index1, end_index2);
		break;
	default:
	{
		char errmsg[64];
