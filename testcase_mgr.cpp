...
bool TestCaseMgr::check_float_value_equal(float expected_value, float actual_value, bool throw_exception)
{
...
void TestCaseMgr::set_show_detail(bool show_detail)
{
	show_test_case_detail = show_detail;
}

void TestCaseMgr::test_check_array()
{
...
void TestCaseMgr::test_check_array_statistics()
{
	static const int ERRMSG_SIZE = 256;
	static char errmsg[ERRMSG_SIZE];
...
void TestCaseMgr::test_check_filter_array()
{
	static const int ERRMSG_SIZE = 256;
	static char errmsg[ERRMSG_SIZE];
...
void TestCaseMgr::test_check_filter_rule()
{
...
void TestCaseMgr::test_check_formula()
{
	ResultSet result_set;
// Generate data
	ResultSet::generate_data_for_simulation(result_set);
...
void TestCaseMgr::test_check_filter_formula()
{
	ResultSet result_set;
	FinanceBoolDataArray filter_data_array;
// Generate data
...
// void TestCaseMgr::test_check_data_statistics()
// {
// 	static const int ERRMSG_SIZE = 256;
// 	static char errmsg[ERRMSG_SIZE];
...
void TestCaseMgr::test_check_histogram()
{
	static const int ERRMSG_SIZE = 256;
	static char errmsg[ERRMSG_SIZE];
...
bool TestCaseMgr::test(TestType test_type)
{
	typedef void (TestCaseMgr::*test_func_ptr)();
	static test_func_ptr test_func_array[] =
	{
		&TestCaseMgr::test_check_array,
		&TestCaseMgr::test_check_array_statistics,
		&TestCaseMgr::test_check_filter_array,
		&TestCaseMgr::test_check_filter_rule,
		&TestCaseMgr::test_check_formula,
		&TestCaseMgr::test_check_filter_formula,
		// &TestCaseMgr::test_check_data_statistics,
		&TestCaseMgr::test_check_histogram
	};
